...
import 'package:red_blackboard/data/services/work_pool.dart';
import 'package:red_blackboard/domain/models/public_job.dart';
            ...
            itemBuilder: (context, index) {
              ...
              return OfferCard(
                ...
                onApply: () => {
                  Get.showSnackbar(
                    GetBar(
                      message: "Has aplicado para esta conferencia.",
